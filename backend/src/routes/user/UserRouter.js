...
UserRouter.patch("/refresh-token",
     //doJwtAuth, 
...
UserRouter.post("/:userId/add-follow",
     //doJwtAuth,
     UserController.addFollowCtrl);

UserRouter.post("/:userId/not-follow",
     //doJwtAuth, 
     UserController.unFollowCtrl);
